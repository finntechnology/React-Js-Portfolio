  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <h2 className="footer--logo">DEF</h2>
        </div>
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/finntgif?igsh=cXJhem43dTU0ejJz&utm_source=qr"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/daniel-ebuka-finn-3577472b6/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">
          @2024 Daniel Ebuka Finn ALL RIGHT RESERVED.
        </p>
        <div className="footer--social--icon">
          <ul>
            <li>
